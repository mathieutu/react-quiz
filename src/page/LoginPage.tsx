...
export default function LoginPage(){
    ...
    const handleSubmit = () => {
        ...
        if(form !== undefined && form !== null && form.reportValidity()){
        ...
        <div className="text-lg flex h-screen bg-white w-screen">
            <form id="login-form" onSubmit={handleSubmit} className="m-auto w-100 shadow-lg bg-gray-300 flex flex-col p-6">
                ...
                <div className="mt-10 flex">
                    <div onClick={handleSubmit} className="my-btn-anim select-none mx-auto px-4 py-2 rounded text-white bg-gradient-to-r from-teal-400 to-blue-500 shadow-md cursor-pointer transition duration-150 hover:shadow-lg">
                        Commencer
